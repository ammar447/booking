<template>
  <div class="content-container" style="z-index: 9999">
    ...
    <div class="center-box">
	  ...
	  <div :class="v$.NewUser.en_name.$error == true ? 'form-group--error' : ''">
	  ...
	  <div :class="v$.NewUser.nationality.$error == true ? 'form-group--error' : ''">
	  ...
	  <div :class="v$.NewUser.en_nationality.$error == true ? 'form-group--error' : ''">
        <div v-for="error of v$.NewUser.en_nationality.$errors" :key="error.$uid">
          <div class="error-msg Font1_16">{{ error.$message }}</div>
        </div>
        <input
          class="LoginInput Font1_16"
      ...
      <div v-for="error of v$.NewUser.company_id.$errors" :key="error.$uid">
          <div class="error-msg Font1_16">{{ error.$message }}</div>
        </div>
    <Select :DataAll="Company_list" @GetValue="SaveCompany_id" :ShowTitle="Company"  />
      <Button
        v-if="!Loading"
...
export default {
  ...
  methods: {
    ...
    this.NewUser.company_id = data.id;
  this.Company= data.name;
    ...
    AddManager() {
      ...
      this.Loading = true;
      this.$store.dispatch("Company/AddSuperUser", this.NewUser).then((res) => {
        res == true
          ? 
          this.$emit('Close')
  ...
  computed: {
    ...mapState({
      Company_list: (state) => state.Company.Company_list,
    }),
  },
};
</script>
